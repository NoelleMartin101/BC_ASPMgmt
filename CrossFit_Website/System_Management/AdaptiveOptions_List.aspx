...
<asp:Content ID="pageContent" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDs_AdaptiveOptions_ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:CrossfitTrackerConnectionString %>" SelectCommand="AdaptiveOptions_ViewAll" SelectCommandType="StoredProcedure" />
</asp:Content>
