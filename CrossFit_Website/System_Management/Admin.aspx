            ...
            <tr>
                <td style="width: 33%; vertical-align: top;">
                    <div class="list-group col-md-3" style="width: 100%">
                        <a class="list-group-item list-group-item-action" href="SystemVersions_List.aspx?returnurl=Admin.aspx" style="text-align: left; font-size: 16px; background-color: steelblue; color: white;">Reference Data</a>
                ...
                <td style="width: 33%;  vertical-align: top;">
                    <div class="list-group col-md-3" style="width: 100%">
                        <a class="list-group-item list-group-item-action" href="SystemVersions_List.aspx?returnurl=Admin.aspx" style="text-align: left; font-size: 16px; background-color: steelblue; color: white;">CrossFit Data</a>
                ...
                <td style="width: 33%;  vertical-align: top;">
                    <div class="list-group col-md-3" style="width: 100%">
                        <a class="list-group-item list-group-item-action" href="SystemVersions_List.aspx?returnurl=Admin.aspx" style="text-align: left; font-size: 16px; background-color: steelblue; color: white;">Athletes & Judges Data</a>
                      <a class="list-group-item list-group-item-action" href="AdaptiveOptions_List.aspx?returnurl=Admin.aspx">Athlete Profiles</a>
                        ...
                        <a class="list-group-item list-group-item-action" href="AdaptiveOptions_List.aspx?returnurl=Admin.aspx">All Users</a>
