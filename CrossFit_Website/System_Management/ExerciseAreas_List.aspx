...
<asp:Content ID="pageContent" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDs_ExerciseAreas_ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:CrossFitConnectionString %>" SelectCommand="ExerciseAreas_ViewAll" SelectCommandType="StoredProcedure" />
</asp:Content>
