...
<asp:Content ID="pageContent" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDs_Countries_ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:CrossfitTrackerConnectionString %>" SelectCommand="Countries_ViewAll" SelectCommandType="StoredProcedure" />
</asp:Content>
