<%@ Page Title="Registered Users List" Language="C#" MasterPageFile="~/CrossFit.master" AutoEventWireup="true" CodeFile="AllUsers_List.aspx.cs" Inherits="AllUsers_List" %>
...
<asp:Content ID="pageContent" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDs_RegisteredUsers_ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:CrossfitTrackerConnectionString %>" SelectCommand="RegiseredUsers_ViewAll" SelectCommandType="StoredProcedure" />
